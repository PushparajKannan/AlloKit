...
public class SaveSharedPreference {
    ...
    private static final String UPPIID= "upiid";
...
public static void setDistLogo(Context context, String lang) {
    ...
    public static String getUPIID(Context ctx) {
        return getSharedPreferences(ctx).getString(UPPIID, "");
    }

    public static void setUPIID(Context context, String lang) {
        editor = getSharedPreferences(context).edit();
        editor.putString(UPPIID,lang);
        editor.apply();
    }
